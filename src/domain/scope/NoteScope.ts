...
import { OUTLINE_FLAG } from "../plot/Outline";
...
export const PLUGIN_DATA_FLAGS: readonly string[] = [WRITING_LOG_FLAG, STORY_MAP_FLAG, STORY_THREADS_FLAG, MANUSCRIPT_EXPORT_FLAG, OUTLINE_FLAG];
