...
| **Writer: next lane** / **previous lane** / **next group** / **previous group** / **new note in the focused group** / **fit the board** / **show keyboard shortcuts** | The [writer board's keys](/guide/writer#the-keyboard) as commands, live while the board is the active tab, so they can be given hotkeys of your own. |
